...
import {postCottageReservationReviewService} from "../api/cottageApiService";

const NewCottageReservationScreen = () => {
  const navigate = useNavigate();

  let {cottageId, reservationId} = useParams();
  ...
  const handleSubmit = async (formData, {setSubmitting}) => {
    try {
      setSubmitting(true);
      await postCottageReservationReviewService(reservationId, formData)
      setSubmitting(false);
